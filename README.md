...
### **Step 1: Start with AI Logic** 🤖
### **Step 2: Implement Vector Retrieval** 🗄️  
### **Step 3: Configuration Setup** 📝
### **Step 4: API Layer** 🚀
### **Step 5: Background Tasks (BONUS)** ⚡
...
### 4. 🚀 **main.py** & 📊 **schemas.py** - API Implementation
...
**📖 Note:** [`models.py`](models.py) is **READ-ONLY** - do not edit this file. It contains the complete SQLAlchemy setup and [`Tweet`](models.py) model that you should use as-is.
...
### 5. ⚡ **background.py** - Background Tasks (BONUS)
**What to implement:**
